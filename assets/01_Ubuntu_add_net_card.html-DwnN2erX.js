import{_ as n,c as e,a,o as l}from"./app-CmJZ5i3S.js";const i={};function t(d,s){return l(),e("div",null,[...s[0]||(s[0]=[a(`<h1 id="ubuntu-22-04-新增网卡配置" tabindex="-1"><a class="header-anchor" href="#ubuntu-22-04-新增网卡配置"><span>Ubuntu 22.04+ 新增网卡配置</span></a></h1><p>Ubuntu 2204 LTS 开始，新增了 <code>cloud-init</code> 的配置，</p><p>如果不手动配置 <code>network: {config: disabled}</code>，每次重启电脑，网卡配置都会被重置，新添加的网卡不会自动 up 起来。</p><blockquote><p>也是奇了怪， 都 2025 年了， Ubuntu 2204 的网卡配置在中文互联网上还是一条正确的网卡配置教程都没有。。。</p><p>各界 AI 也是一派胡言，没有一个能答对的。</p></blockquote><ol><li>查看网卡名称</li></ol><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">sudo ip a</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><ol start="9"><li>查看 IP 和 重启系统 再次查看 IP，</li></ol><blockquote><p>重启电脑的时候网络配置不会被自动重制了。</p></blockquote>`,27)])])}const p=n(i,[["render",t]]),r=JSON.parse('{"path":"/blogs/tech/linux/ubuntu/01_Ubuntu_add_net_card.html","title":"Ubuntu 22.04+ 新增网卡配置","lang":"en-US","frontmatter":{"title":"Ubuntu 22.04+ 新增网卡配置","date":"2025-02-10T00:00:00.000Z","tags":["Networking"],"categories":["tech"]},"headers":[],"git":{"createdTime":1776090935000,"updatedTime":1776090935000,"contributors":[{"name":"PPPerryPan","email":"perrypan0123@outlook.com","commits":1}]},"filePathRelative":"blogs/tech/linux/ubuntu/01_Ubuntu_add_net_card.md"}');export{p as comp,r as data};
