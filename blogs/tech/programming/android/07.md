...
![image-20220512180825913](./07.assets/image-20220512180825913.png)

然后用返回键退出程序，打开 Device File Explorer 查看程序目录\file下的data文件内容，即可看到刚才写入的内容

![image-20220512180949549](./07.assets/image-20220512180949549.png)
...
![image-20220512200302300](./07.assets/image-20220512200302300.png)
...
![image-20220513180544022](./07.assets/image-20220513180544022.png)
...
![image-20220513195026342](./07.assets/image-20220513195026342.png)

### ~~记住密码功能 (以后再补)~~

**此段使用：`ext.kotlin_version = '1.3.40'` 实现**

**Perry-HonLap18** ：D:\perry\Documents\AndroidStudioProjects\Old\BroadcastBestPractice

- src/main/java/com/example/broadcastbestpractice/LoginActivity.kt
...
![image-20220514193805558](./07.assets/image-20220514193805558.png)



文件管理器中也能够找到该数据库

![image-20220514194434028](./07.assets/image-20220514194434028.png)
...
![image-20220514195157200](./07.assets/image-20220514195157200.png)

![image-20220514195404835](./07.assets/image-20220514195404835.png)



查看数据库

![image-20220514195503746](./07.assets/image-20220514195503746.png)
...
![image-20220514211619219](./07.assets/image-20220514211619219.png)
...
![image-20220514214648030](./07.assets/image-20220514214648030.png)
...
![image-20220514220529914](./07.assets/image-20220514220529914.png)
...
![image-20220515204152525](./07.assets/image-20220515204152525.png)
...
![image-20220516002204383](./07.assets/image-20220516002204383.png)
