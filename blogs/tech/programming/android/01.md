...
![img](./01.assets/android-stack_2x.png)
...
- 切换到Android标签，等待初始化
  ...
  ![image-20220308145107481](./01.assets/image-20220308145107481.png)


#### 目录结构

![image-20220308155854640](./01.assets/image-20220308155854640.png)

![image-20220308161136925](./01.assets/image-20220308161136925.png)
...
- app --> manifests --> AndroidManifest.xml
  ...
  ![image-20220308161539191](./01.assets/image-20220308161539191.png)
...
- app --> java --> com.example.helloworld --> MainActivity
  ...
  ![image-20220308161952254](./01.assets/image-20220308161952254.png)

  - `activity_main` 可 Ctrl + 鼠标定位

- app --> res --> activity_main.xml

  ![image-20220308162300278](./01.assets/image-20220308162300278.png)
...
- 测试：
  ...
  ![image-20220308163147957](./01.assets/image-20220308163147957.png)

  ![image-20220308163843118](./01.assets/image-20220308163843118.png)
