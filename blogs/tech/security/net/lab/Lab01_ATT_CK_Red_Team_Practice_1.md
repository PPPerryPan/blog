...
![image-20220810172541831](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810172541831.png)

虚拟机网络配置：

![image-20220810180624518](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810180624518.png)



Win7中确认防火墙状态

![image-20220810210622951](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810210622951.png)

将三台靶机关机创建快照，然后全部启动（Kali也要），并启动Win7的PHP和MySQL。

![image-20220810213508539](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810213508539.png)
...
![image-20220810213657373](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810213657373.png)



登陆网站，发现phpStudy探针，暴露大量隐私信息

![image-20220810214003621](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810214003621.png)



3306端口的MySQL也可见，使用弱口令`root`, `root`也成功登陆

![image-20220810214158744](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810214158744.png)
...
![image-20220810235251383](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220810235251383.png)
...
![image-20220811142631141]./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811142631141.png)
...
![image-20220811142846156](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811142846156.png)
...
![image-20220811143010076]./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811143010076.png)



在后台“前台模板”模块中发现可以编辑模板，模板通常可以自定义php文件，而如果可以自定义php文件直接就可以上一句话木马了。

![image-20220811143241513](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811143241513.png)

![image-20220811143326582](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811143326582.png)
...
![image-20220811143422502](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811143422502.png)
...
![image-20220811143650676](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811143650676.png)

到蚁剑中右键 添加数据：

`http://192.168.220.138/yxcms/protected/apps/default/view/default/info.php`

![image-20220811144748232](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811144748232.png)



到shell里看一下`ipconfig`

![image-20220811145021077](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811145021077.png)

查看防火墙状态 `netsh advfirewall show allprofiles`

![image-20220811145156669](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811145156669.png)
...
![image-20220811181014648](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811181014648.png)

#### 上传后门

加壳版和普通版都传，以防万一

![image-20220811181159361](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811181159361.png)

![image-20220811182111039](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811182111039.png)
...
![image-20220811184743952](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811184743952.png)
...
![image-20220811204915927](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811204915927.png)

法二：nmap扫描出的主机端口开放情况判断，192.168.52.138这台主机开启了464端口和389端口

![image-20220811210453367](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811210453367.png)
...
![image-20220811234420908](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811234420908.png)

![image-20220811233638539](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811233638539.png)



不过，蚁剑拿到了shell，回到蚁剑用Win7的nmap来扫就行

![image-20220811233803703](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220811233803703.png)
...
![image-20220812193821408](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220812193821408.png)

![image-20220812193829530](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220812193829530.png)

创建监听器

> 两个IP都填kali的IP就行

![image-20220813012832949](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813012832949.png)

生成后门

![image-20220812203942962](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220812203942962.png)

选择刚才创建的监听器

> 本处图片仅供参考

![image-20220812204000037](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220812204000037.png)

生成x64并保存

![image-20220812204213769](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220812204213769.png)

用蚁剑上传文件，并在蚁剑中的shell将后门运行起来，kali的CS就会有反应

![image-20220813013038873](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813013038873.png)
...
![image-20220813013434738](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813013434738.png)



开多一个监听器

![image-20220813013826709](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813013826709.png)

提权

![image-20220813013626626](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813013626626.png)



![image-20220813014237238](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813014237238.png)



提权成功

![image-20220813014501295](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220813014501295.png)
...
![image-20220814170532122](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814170532122.png)
...
![](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814173528143.png)
...
![image-20220814194107916](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814194107916.png)
...
![image-20220814225454974](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814225454974.png)



网上搜了一下，发现 rdesktop 不适用于 WinXP/2003+ (不含XP/2003)

![image-20220814225701766](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814225701766.png)
...
![image-20220814225917789](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814225917789.png)
...
![image-20220814232334204](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220814232334204.png)
...
![image-20220815002522071](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815002522071.png)

![image-20220815002532623](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815002532623.png)
...
![image-20220815002731903](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815002731903.png)
...
![image-20220815013954624](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815013954624.png)

经检查，发现是网卡识别错误，需要将其他无用网卡禁用后才能拿到正确的internal IP

![image-20220815151257133](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815151257133.png)

怎么探测都没反应，命令不执行

![image-20220815151634275](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815151634275.png)

发现是CS的bug，自己敲一遍就行了

![image-20220815151840765](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815151840765.png)



回到列表视图，扫端口

![image-20220815152357885](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815152357885.png)
...
![image-20220815155618348](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815155618348.png)

![image-20220815155810801](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815155810801.png)
...
![image-20220815174304021](./Lab01_ATT_CK_Red_Team_Practice_1.assets/image-20220815174304021.png)
