...
![1_cMaster设备名](./Lab1_Hadoop.assets/1_cMaster设备名.png)

- 配置IP

![2_cMaster配置IP](./Lab1_Hadoop.assets/2_cMaster配置IP.png)

- 配置hosts **（注：记得sudo；且三台机器都要配）**

![3_cMaster配置hosts](./Lab1_Hadoop.assets/3_cMaster配置hosts.png)
...
![5_cSlave1网卡生成新地址](./Lab1_Hadoop.assets/5_cSlave1网卡生成新地址.png)

- 配置IP

![6_cMaster1配置IP](./Lab1_Hadoop.assets/6_cMaster1配置IP.png)
...
![8_cMaster2配置IP](./Lab1_Hadoop.assets/8_cMaster2配置IP.png)
