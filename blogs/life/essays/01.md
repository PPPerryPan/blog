...
1. 前往Microsoft ID管理页面，新建 Microsoft ID 应用密码。
    ...
    ![MSID_APPPpwd](01.assets/MSID.jpg)
...
2. 前往 Apple ID管理页面，创建Apple ID应用密码
    ...
    ![AppleID_APPPpwd](01.assets/AppleID.jpg)
...
* 打开系统自带的`日历`应用，PC此前已连接到MS ID（若未连接可通过向导连接），故只需将`日历`应用连接到iCloud（**使用AppleID App专用密码登录**）
    ![Win_Cale1](01.assets/Win_Cale1.jpg)
    **MSID, AppleID 日历同步配置**

* 打开系统自带的`Microsoft To Do`应用，通过向导连接到MS账号。
    ![Win_ToDo1](01.assets/Win_ToDo1.jpg)
    **MSID 提醒事项同步配置**

* 打开系统自带的`Edge(Chromium)`应用，打开iCloud官网`iCloud.com`，将其安装为应用
    ![Win_ToDo2](01.assets/Win_ToDo2.jpg)
    **安装为应用，关闭浏览器**

    ![Win_ToDo3](01.assets/Win_ToDo3.jpg)
    **打开iCLoud应用，登录账号**

    ![Win_ToDo4](01.assets/Win_ToDo4.jpg)
...
* 打开系统`设置-互联网账户`，macOS此前已连接到AppleID，故只需登录MS Exchange账户（**使用MSID应用密码登录**）
    ![macOS_1](01.assets/macOS_1.png)
    **MSID登录**

    ![macOS_2](01.assets/macOS_2.png)
    **根据需求勾选同步选项**

    ![macOS_3](01.assets/macOS_3.jpg)
    **完成MSID 日程&提醒事项 同步配置**
...
*   ![Android_iCloud](01.assets/Android_iCloud.jpg)
    **可同步iCloud日程到Google Calendar**

*   ![Android_TD](01.assets/Android_TD.jpg)
    **通过MS Outlook & MS To Do 同步iCloud日历、Outlook日程、MS提醒事项**

*   ![Android_OI](01.assets/Android_OI.jpg)
...
* 打开系统`设置-邮件-账户(iOS13+)`或`设置-密码与账户(iOS12)`，i(Pad)OS此前已连接到AppleID，故只需登录MS Exchange账户（**使用MSID应用密码登录**）,或登录Outlook账户）（**使用MSID原密码登录**）
    ![iOS_1](01.assets/iOS_1.png)
    **MSID登录**

    ![iOS_2](01.assets/iOS_2.png)
    **根据需求勾选同步选项**

    ![iOS_3](01.assets/iOS_3.png)
    **完成MSID 日程&提醒事项 同步配置**
